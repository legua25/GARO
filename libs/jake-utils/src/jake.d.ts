...
declare module 'jake' {
     ...
     */
    export function complete(value?: any): void;
     ...
     */
    export function directory(name:string): DirectoryTask;
     ...
     */
    export function fail(...err:string[]): void;
     ...
     */
    export function file(name:string, prereqs?:string[], action?:(this: FileTask)=>void, opts?:FileTaskOptions): FileTask;
     ...
     * @param opts Perform this task asynchronously. If you flag a task with this option, you must call the global `complete` method inside the task's action, for execution to proceed to the next task.
     */
    export function rule(pattern: RegExp, source: string | { (name: string): string; }, prereqs?: string[], action?: () => void, opts?: TaskOptions): void;
     ...
     */
    export function namespace(name:string, scope:()=>void): void;
     ...
     * @param opts
     */
    export function task(name:string, prereqs?:string[], action?:(this: Task, ...params:any[])=>any, opts?:TaskOptions): Task;
    export function task(name:string, action?:(this: Task, ...params:any[])=>any, opts?:TaskOptions): Task;
    export function task(name:string, opts?:TaskOptions, action?:(this: Task, ...params:any[])=>any): Task;
     ...
     */
    export function npmPublishTask(name:string, packageFiles:string[]): NpmPublishTask;
    export function npmPublishTask(name:string, definition?:()=>void): NpmPublishTask;
